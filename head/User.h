...
// Abstract Class Describing a GPS user.
class User{
    ...
    public:
        ...
        User(std::string n, CityPtr c, WorldMap& m);
        ...
        virtual std::vector<std::string> getAcessibleFromBy(const std::string& c, const std::vector<std::string> modes = {}) const;
        ...
        // virtual std::tuple<std::vector<LinkPtr>,float> getAccessibleFromBy(const std::string& to_c, const std::string& from_c = "", const std::vector<std::string> modes = {} ) const = 0;
